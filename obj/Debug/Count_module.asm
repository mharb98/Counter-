...
;--------------------------------------------------------
	global	_COUNT_INIT
	global	_COUNT_UPDATE

;--------------------------------------------------------
; global definitions
;--------------------------------------------------------
UD_Count_module_0	udata
; FCount_module_Number_0_0 == .
_Number	res	2
...
;	  143+   49 =   192 instructions (  482 byte)
